...
MCMCddU <- function(burnin = 10000, niter = 100000, thin = 100, 
  delta.lower = .5, delta.upper = 1, phi.lower = 0, 
  phi.upper = .5, kappa.lower = .5, kappa.upper = 1,
  harvestData, data, mupsi, xi, maxSight)
{
  d2 = data
...
harvSample <- function(H) {
    ...
    if(testLamMu(thetaX1.try, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLddU(hr, thetaX1.try, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho)
    ...
    if(testLamMu(thetaX1, thetaY1.try, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLddU(hr, thetaX1, thetaY1.try, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy.try, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
     LLdif <- LLddU(hr, thetaX1, thetaY1, betaXdy.try, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
     ...
     LLdif <- LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2.try, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr.try, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2.try,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, mupsi, xi, rho) -
      LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddU(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
