...
#' @param delta.lower lower bound for uniform prior on delta
#' @param delta.upper upper bound for uniform prior on delta
#' @param phi.lower lower bound for uniform prior on phi
#' @param phi.upper upper bound for uniform prior on phi
#' @param kappa.lower lower bound for uniform prior on kappa
#' @param kappa.upper upper bound for uniform prior on kappa
#' @param harvestData harvest dataset
#' @param data  survey dataset
#' @param xi exponential scale parameter for prior on psi
...
MCMCddUniPrior <- function(burnin = 10000, niter = 100000, thin = 100, 
  delta.lower = .5, delta.upper = 1, phi.lower = 0, 
  phi.upper = .5, kappa.lower = .5, kappa.upper = 1,
  harvestData, data, xi, maxSight)
{
  d2 = data
...
harvSample <- function(H) {
    ...
    if(testLamMu(thetaX1.try, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLddUniPrior(hr, thetaX1.try, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho)
    ...
    if(testLamMu(thetaX1, thetaY1.try, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLddUniPrior(hr, thetaX1, thetaY1.try, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy.try, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
     LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy.try, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
     ...
     LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2.try, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr.try, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2.try,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
    ...
    for(i in 1:length(delta)) {
      delta.try <- delta
      U <- log(runif(1))
      delta.try[i] <- min(max(delta[i] + runif(1)*0.05 - 0.025, delta.lower),delta.upper)
    ...
    for(i in 1:length(phi)) {
      phi.try <- phi
      U <- log(runif(1))
      phi.try[i] <- min(max(phi[i] + runif(1)*0.05 - 0.025, phi.lower),phi.upper)
    ...
    for(i in 1:length(kappa1)) {
      kappa1.try <- kappa1
      U <- log(runif(1))
      kappa1.try[i] <- min(max(kappa1[i] + runif(1)*0.05 - 0.025, kappa.lower),kappa.upper)
    ...
    U <- log(runif(1))
    psi.try <- min(max(psi + runif(1)*0.04 - 0.02, 0),1)
    LLdif <- LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        psi.try, xi, rho) -
      LLddUniPrior(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
