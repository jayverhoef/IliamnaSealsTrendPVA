...
MCMCdd <- function(burnin = 10000, niter = 100000, thin = 100, 
...
harvSample <- function(H) {
    ...
    if(testLamMu(thetaX1.try, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLdd(hr, thetaX1.try, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho)
    ...
    if(testLamMu(thetaX1, thetaY1.try, delta, kappa1, phi, rho, betaXdy, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
    LLdif <- LLdd(hr, thetaX1, thetaY1.try, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy.try, H,
      betaXdy2, betaXhr, betaXhr2, betaYdy, betaYdy2, betaYhr, betaYhr2, d2)) {
     LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy.try, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho, betaXdy, H,
     ...
     LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2.try, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr.try, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2.try,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
    ...
    LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
    ...
    LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi.try, mupsi, xi, rho) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho)
    ...
    if(testLamMu(thetaX1, thetaY1, delta, kappa1, phi, rho.try, betaXdy, H,
		...
		LLdif <- LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho.try) -
      LLdd(hr, thetaX1, thetaY1, betaXdy, betaXdy2, betaXhr, betaXhr2,
        betaYdy, betaYdy2, betaYhr, betaYhr2, delta, phi, kappa1, sigX, sigY, d2, H,
        adelta, bdelta, aphi, bphi, akappa, bkappa, psi, mupsi, xi, rho)
