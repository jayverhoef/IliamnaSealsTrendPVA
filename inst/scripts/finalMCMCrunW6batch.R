# can run this in command window, run this as R CMD BATCH '/mnt/Hitachi2GB/00NMML/activePapers/IliamnaSealsTrendPVA/package/IliamnaSealsTrendPVA/inst/scripts/finalMCMCrunW6batch.R'
