...
%The female productivity (fertility) value of round(pp,3) for all females ages 3+ was obtained from \citet{Pitc:Calk:biol:1979}. Fertility, or reproductive rates are expected to change with the age of females \citep{Bigg:harb:1969}, and geography \citep{Pitc:Calk:biol:1979}, but when the data were pooled for all females ages 3+, a total of round(xx,0) out of round(nn,0) females produced pups in the Gulf of Alaska, the nearest place to Iliamna Lake for such data. The standard error for female productivity was obtained assuming independent trials from a binomial distribution. Note that for multiparous females, \citet{Pitc:Calk:biol:1979} reported pregnancy rates of 0.893. Despite the differences in geography, in British Columbia, a very similar multiparous value of round(Bigg.pp,2) is obtained by pooling data from \citet{Bigg:harb:1969} and \citet{Grei:preg:2002}, where round(Bigg.xx,2) out of round(Bigg.nn,2) females produced offspring. In Scotland, \citet{Cord:Thom:mark:2014} estimated unconditional multiparous fecundity at 0.89, while fecundity for all females aged 3+ was 0.69. It appears that fecundity is very similar around the world.
...
%  \hline
%  \hline
%  1 & $\delta$ & round(delta,3) & formatC(varDelta,digits = 6, format = 'f') & 
%    round(aDelta,2) & round(bDelta,2) \\ 
%  1 & $\phi$ & round(phi,3) & formatC(varPhi,digits = 6, format = 'f') & 
%    round(aPhi,2) & round(bPhi,2) \\ 
%  1 & $\kappa$ & round(kappa1,3) & formatC(varKappa,digits = 6, format = 'f') & 
%    round(aKappa,2) & round(bKappa,2) \\ 
%  \hline
%  2 & $\delta$ & round(delta2,3) & formatC(varDelta2,digits = 6, format = 'f') &
%    round(aDelta2,2) & round(bDelta2,2) \\ 
%  2 & $\phi$ & round(phi2,3) & formatC(varPhi2,digits = 6, format = 'f') &
%    round(aPhi2,2) & round(bPhi2,2) \\ 
%  2 & $\kappa$ & round(kappa2,3) & formatC(varKappa2,digits = 6, format = 'f') &
%    round(aKappa2,2) & round(bKappa2,2) \\ 
%  \hline
%  3 & $\delta$ & 0.750 & formatC(varUnif,digits = 6, format = 'f') & { } & { } \\ 
%  3 & $\phi$ & 0.250 & formatC(varUnif,digits = 6, format = 'f') & { } & { } \\ 
%  3 & $\kappa$ & 0.750 & formatC(varUnif,digits = 6, format = 'f') & { } & { } \\
%  \hline
%\end{tabular}
%\end{table}
